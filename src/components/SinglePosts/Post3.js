...
import Img1 from "../Assests/icons/ronal.png";
import Calender from "../Assests/icons/calender.png";
  ...
  return (
    <div className="single-post">
      ...
      <div className="post-text">
        <div className="type-post-desc3"></div>
        ...
        <div className="date-location">
          <img src={Calender} alt="icon" width="18px" height="100%" />
          <span>Fir, 12 Oct, 2021</span>
